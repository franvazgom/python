...
class TestGenerator:
    ...
    def generate_names_inputs(self):
        ...
        Si alguno solo recibe un argumento, aún así se debe de poner en una
        tupla. No olvidar poner la coma que indica que un elemento único
        es tupla.
        """
        n = randint(50, 1000)

        inputs = [([randint(0, 500) for _ in range(n)],)]
...
if __name__ == "__main__":
    tests = TestGenerator(None, ["unicos"])
