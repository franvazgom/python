...
-------------------------------------------------
- 04 Calcula tiempo
Escribe un programa que pregunte al usuario su edad y el año actual, como resultado le indicará el año en que cumplirá 100 años.
...
-------------------------------------------------
- 05 Calcula lustros
Escribe un programa que indique el número de lustros que ha vivido una persona por medio de su año de nacimiento y el año actual.
...
Escribe un programa calcular la cantidad de litros de pintura necesarios para pintar una superficie.
...
Escribe un programa que calcule la distancia entre dos puntos del plano cartesiano.
